...
class TradeOrdercloseRequestMarshaller implements RequestMarshaller
{
    /**
     * @var TradeOrdercloseRequestMarshaller
     */
    private static $instance;

    public static function __init()
    {
        self::$instance = new TradeOrdercloseRequestMarshaller();
    }

    /**
     * @return TradeOrdercloseRequestMarshaller
     */
     ...
     * @var string
     */
    private $resourcePath = '/rest/v1.0/std/trade/orderclose';
    ...
    /**
     * @param TradeOrdercloseRequest $request
     * @return Request
     */
...
TradeOrdercloseRequestMarshaller::__init();
