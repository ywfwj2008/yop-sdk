...
class PromotionUpdateRequestMarshaller implements RequestMarshaller
{
    /**
     * @var PromotionUpdateRequestMarshaller
     */
    private static $instance;

    public static function __init()
    {
        self::$instance = new PromotionUpdateRequestMarshaller();
    }

    /**
     * @return PromotionUpdateRequestMarshaller
     */
     ...
     * @var string
     */
    private $resourcePath = '/rest/v1.0/mktg/promotion/update';
...
PromotionUpdateRequestMarshaller::__init();
