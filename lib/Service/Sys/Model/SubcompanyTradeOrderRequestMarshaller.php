...
class SubcompanyTradeOrderRequestMarshaller implements RequestMarshaller
{
    /**
     * @var SubcompanyTradeOrderRequestMarshaller
     */
    private static $instance;

    public static function __init()
    {
        self::$instance = new SubcompanyTradeOrderRequestMarshaller();
    }

    /**
     * @return SubcompanyTradeOrderRequestMarshaller
     */
     ...
     * @var string
     */
    private $resourcePath = '/rest/v1.0/sys/subcompany/trade/order';
    ...
    /**
     * @param SubcompanyTradeOrderRequest $request
     * @return Request
     */
    public function marshal($request)
    {
        ...
        if($request->getSettleProcessType() != null){
            $internalRequest->addParameter('settleProcessType', ObjectSerializer::sanitizeForSerialization($request->getSettleProcessType(), 'string'));
        }
...
SubcompanyTradeOrderRequestMarshaller::__init();
