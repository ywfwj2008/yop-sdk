...
function authorizeurlquery(){
    ...
    $response = YopClient3::post("/rest/v1.0/sys/merchant/authorizeurlquery", $request);
...
<tr>
				<td width="25%" align="left">&nbsp;页面授权 url  </td>
				<td width="5%"  align="center"> : </td> 
				<td width="35%" align="left"> <?php echo  $result['merAuthorizeWebUrl'];?> </td>
				<td width="5%"  align="center"> - </td> 
				<td width="30%" align="left">merAuthorizeWebUrl</td> 
			</tr>
		...
		<tr>
				...
				<td width="5%"  align="center"> : </td> 
				<td width="35%" align="left"> <?php echo  $result['phone'];?> </td>
				<td width="5%"  align="center"> - </td> 
