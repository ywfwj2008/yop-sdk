    ...
    <tr>
        <td>
            <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1">
                ...
                <tr>
                    <td colspan="2" bgcolor="#CEE7BD">子商户费率修改接口</td>
                </tr>

                <form method="post" action="sendFee.php" targe="_blank">
                    <tr>
                    ...
                    <tr>
                        <td align="left">&nbsp;&nbsp;支付产品</td>
                        <td align="left">&nbsp;&nbsp;<input size="50" type="text" name="payProductMap"
                                                            id="payProductMap" value=""/>
                            &nbsp;<span style="color:#FF0000;font-weight:100;">*</span></td>
                    </tr>
