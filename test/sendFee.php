...
function fee()
{
    ...
    $request->addParam("payProductMap", $_REQUEST['payProductMap']);


    $response = YopClient3::post("/rest/v1.0/merchantService/mer-product-info/mer-product-fee-update-for-o2o", $request);
