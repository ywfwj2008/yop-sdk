...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	...
	<body>
		<table width="50%" border="0" align="center" cellpadding="0" cellspacing="0" style="border:solid 1px #107929">
		  ...
		  <tr>
		  	<td colspan="2" bgcolor="#CEE7BD"获取支行信息接口</td>
		  </tr>
      	...
      	&nbsp;<span style="color:#FF0000;font-weight:100;">*</span></td></tr>
		  	...
		  	<td align="left">&nbsp;&nbsp;<input size="50" type="text" name="provinceCode" id="provinceCode"  value=""/>
       &nbsp;<span style="color:#FF0000;font-weight:100;">*</span></td></tr>	

		        				  <tr>
		  	<td align="left">&nbsp;&nbsp;市编码</td>
		  	<td align="left">&nbsp;&nbsp;<input size="50" type="text" name="cityCode" id="cityCode"  value=""/>
      	 &nbsp;<span style="color:#FF0000;font-weight:100;">*</span></td></tr>
