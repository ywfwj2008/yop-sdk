...
class RouterClientTest extends TestCase
{
    ...
    public static function setUpBeforeClass()
    {
        ...
        self::$client = RouterClientBuilder::builder($appSdkConfig)->build();
    }

    /**
     * @test
     */
    public function modifyPayProductInfoTest()
    {
        $request = new Model\ModifyPayProductInfoRequest();
        ...
        try{
            $response = self::$client->modifyPayProductInfo($request);
     ...
     * @test
     */
    public function openPayAsyncReportConfigTest()
    {
        $request = new Model\OpenPayAsyncReportConfigRequest();
        ...
        try{
            $response = self::$client->openPayAsyncReportConfig($request);
            print_r($response->getResult());
        }catch (\Exception $e) {
     ...
     * @test
     */
    public function openPayAsyncReportReportTest()
    {
        $request = new Model\OpenPayAsyncReportReportRequest();
        ...
        try{
            $response = self::$client->openPayAsyncReportReport($request);
            print_r($response->getResult());
        }catch (\Exception $e) {
     ...
     * @test
     */
    public function openPayReportQueryTest()
    {
        $request = new Model\OpenPayReportQueryRequest();
        ...
        try{
            $response = self::$client->openPayReportQuery($request);
            print_r($response->getResult());
        }catch (\Exception $e) {
     ...
     * @test
     */
    public function queryPayProductInfoTest()
    {
        $request = new Model\QueryPayProductInfoRequest();

        $request->setRequestNo("requestNo_example");
        $request->setMerchantNo("merchantNo_example");
        try{
            $response = self::$client->queryPayProductInfo($request);
            print_r($response->getResult());
        }catch (\Exception $e) {
