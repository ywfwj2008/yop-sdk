...
class FrontcashierClientTest extends TestCase
{
     ...
     * @test
     */
    public function entrustConfirmTest()
    {
        $request = new Model\EntrustConfirmRequest();
        ...
        $request->setOrderValidate(56);
        try{
            $response = self::$client->entrustConfirm($request);
            print_r($response->getResult());
        }catch (\Exception $e) {
     ...
     * @test
     */
    public function entrustPayTest()
    {
        $request = new Model\EntrustPayRequest();
        ...
        try{
            $response = self::$client->entrustPay($request);
            print_r($response->getResult());
        }catch (\Exception $e) {
     ...
     * @test
     */
    public function entrustQueryTest()
    {
        $request = new Model\EntrustQueryRequest();

        $request->setEntrustProtocolId("entrustProtocolId_example");
        try{
            $response = self::$client->entrustQuery($request);
            print_r($response->getResult());
        }catch (\Exception $e) {
     ...
     * @test
     */
    public function entrustRequestTest()
    {
        $request = new Model\EntrustRequestRequest();
        ...
        $request->setOrderValidate(56);
        try{
            $response = self::$client->entrustRequest($request);
            print_r($response->getResult());
        }catch (\Exception $e) {
