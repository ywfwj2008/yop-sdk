...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	...
	<body>
		<table width="50%" border="0" align="center" cellpadding="0" cellspacing="0" style="border:solid 1px #107929">
		  ...
		  <tr>
		  	<td colspan="2" bgcolor="#CEE7BD"企业注册</td>
		  </tr>
      	...
      	&nbsp;<span style="color:#FF0000;font-weight:100;">*</span></td></tr>
		  	...
		  	<td align="left">&nbsp;&nbsp;<input size="50" type="text" name="merFullName" id="merFullName"  value=""/>
       </td></tr>	

		        				  <tr>
		  	<td align="left">&nbsp;&nbsp;商户品牌名称/简称</td>
		  	<td align="left">&nbsp;&nbsp;<input size="50" type="text" name="merShortName" id="merShortName"  value=""/>
      	 </td></tr
		       				  <tr>
		  	<td align="left">&nbsp;&nbsp;证件类型</td>
		  	<td align="left">&nbsp;&nbsp;<input size="50" type="text" name="merCertType" id="merCertType"  value=""/>
      	 </td></tr>
		 <tr>
		  	<td align="left">&nbsp;&nbsp;证件号</td>
		  	<td align="left">&nbsp;&nbsp;<input size="50" type="text" name="merCertNo" id="merCertNo"  value=""/>
       &nbsp;<span style="color:#FF0000;font-weight:100;">*</span></td></tr>
	  ...
	  <tr>
       ...
       <tr>
		  	...
		  	<td align="left">&nbsp;&nbsp;<input size="50" type="text" name="merContactName" id="merContactName"  value=""/>
      	&nbsp; <span style="color:#FF0000;font-weight:100;">*</span></td></tr>
		    <tr>
	  ...
	  <tr>
		  	...
		  	<td align="left">&nbsp;&nbsp;<input size="50" type="text" name="taxRegistCert" id="taxRegistCert"  value=""/></td></tr>
		  <tr>
		  	<td align="left">&nbsp;&nbsp;开户许可证编号</td>
		  	<td align="left">&nbsp;&nbsp;<input size="50" type="text" name="accountLicense" id="accountLicense"  value=""/></td></tr>
	
      		  <tr>
		  	<td align="left">&nbsp;&nbsp;组织机构代码证</td>
		  	<td align="left">&nbsp;&nbsp;<input size="50" type="text" name="orgCode" id="orgCode"  value=""/></td></tr>
	 		  <tr>
		  	<td align="left">&nbsp;&nbsp;组织机构代码证是否长期有效</td>
		  	<td align="left">&nbsp;&nbsp;<input size="50" type="text" name="isOrgCodeLong" id="isOrgCodeLong"  value="true"/></td></tr>
	
      	 		  <tr>
		  	<td align="left">&nbsp;&nbsp;组织机构代理证有效期</td>
		  	<td align="left">&nbsp;&nbsp;<input size="50" type="text" name="orgCodeExpiry" id="orgCodeExpiry"  value="true"/></td></tr>
