...
<html>
	...
	<body>
		<form method="post" action="sendBin.php" accept-charset="UTF-8" target="_blank">
			<table width="80%" border="0" align="center" cellpadding="5" cellspacing="0" style="border:solid 1px #107929">
				...
				<tr >
					...
					<td width="55%" align="left"> 
						<input size="70" type="text" name="bankCardNo" value="" />
						<span style="color:#FF0000;font-weight:100;">*</span>
					</td>
					<td width="5%"  align="center"> - </td> 
					<td width="15%" align="left">bankCardNo</td> 
				</tr>
				<tr >
