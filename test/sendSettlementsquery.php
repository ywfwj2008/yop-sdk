...
<table width="70%" border="0" align="center" cellpadding="5" cellspacing="0" style="border:solid 1px #107929">
    ...
    <tr>
        ...
        <td width="5%" align="center"> :</td>
        <td width="35%" align="left"><textarea cols="70" rows="5">  <?php if (empty($result['settleRecordList'])) {
                    echo "";
                } else {
                    echo preg_replace("#\\\u([0-9a-f]{4})#ie", "iconv('UCS-2BE', 'UTF-8', pack('H4', '\\1'))", json_encode($result['settleRecordList'])), "\n";
                } ?>  </textarea></td>
        <td width="5%" align="center"> -</td>
